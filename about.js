    ...
    <br><br>
        ...
        hebrew = {
            weBelieve: {
                ...
                אנחנו מאמינים במסירות למצוינות. איכות היא בלב הכל מה שאנחנו עושים. מהרעיון הראשוני ועד ליצירת העבודה הסופית, אנחנו שואפים למושלמות בכל פרט. השביעות רצונך היא העדיפות הראשונה שלנו, ולא נשבת עד שנחרוג מהציפיות שלך.`
            },
            aboutUs: {
                title: "קצת עלינו",
